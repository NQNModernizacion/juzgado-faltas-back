...
class StoreActaRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'infractores.*.observaciones.max' => 'Las observaciones no pueden superar los 255 caracteres.',
            'infractores.*.tipo_id.required' => 'El tipo es obligatorio.',
            'infractores.*.tipo_id.integer' => 'El tipo debe ser un número entero.',
            'infractores.*.tipo_id.exists' => 'El tipo seleccionado no existe.',
            ...
            'padrones.*.observaciones.max' => 'Las observaciones no pueden superar los 255 caracteres.',
            'padrones.*.tipo_id.required' => 'El tipo es obligatorio.',
            'padrones.*.tipo_id.integer' => 'El tipo debe ser un número entero.',
            'padrones.*.tipo_id.exists' => 'El tipo seleccionado no existe.',
