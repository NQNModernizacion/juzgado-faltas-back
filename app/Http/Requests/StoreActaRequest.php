...
class StoreActaRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'padrones.*.tipo_id.required' => 'El tipo de padrón es obligatorio.',
            'padrones.*.tipo_id.integer' => 'El tipo de padrón debe ser un número entero.',
            'padrones.*.tipo_id.exists' => 'El tipo de padrón seleccionado no existe.',
